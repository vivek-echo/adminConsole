...
@Component({
  selector: 'app-manage-menu-link',
  standalone: true,
  imports: [CommonModule,RouterModule,MaterialModule],
  templateUrl: './manage-menu-link.component.html',
  styleUrl: './manage-menu-link.component.scss'
})
export class ManageMenuLinkComponent implements OnInit, OnDestroy  {
  tabMenuData: any[] = [];
  ...
  constructor(
    ...
    this.tabMenuData = this.tabNavigationServiceService.getTabLinks("/console/manageLink/manageMenuLink") || [];
    this.primaryMenuData = this.tabNavigationServiceService.getPrimaryLinks("/console/manageLink/manageMenuLink");
